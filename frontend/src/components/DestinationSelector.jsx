...
import { Navigation2, ChevronDown, X, Check } from 'lucide-react';
...
export default function DestinationSelector({
  ...
  return (
    <div ref={wrapperRef} style={{ position: 'relative' }}>
      ...
      >
        <div className="location-marker-dot dot-dest" />
              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <Navigation2 size={16} color={isSelected ? 'var(--color-dest)' : 'var(--text-muted)'} />
                    <div>
                  ...
                  {isSelected && <Check size={16} color="var(--color-dest)" />}
                </div>
              );
            })
          )}
